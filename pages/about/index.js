          ...
          <div className="hidden md:flex md:max-w-xl xl:max-w-none mx-auto xl:mx-0 mb-8">
            <div className="flex flex-1 xl:gap-x-6">
              ...
              <div className="relative flex-1 after:w-[1px] after:h-full after:bg-white/10 after:absolute after:top-0 after:right-0">
                <div className="text-2xl xl:text-4xl font-extrabold text-blue-400 mb-2">
              ...
              <div className="relative flex-1 after:w-[1px] after:h-full after:bg-white/10 after:absolute after:top-0 after:right-0">
                <div className="text-2xl xl:text-4xl font-extrabold text-blue-400 mb-2">
                  <CountUp start={0} end={139} duration={5} /> +
                </div>
                <div className="text-xs uppercase tracking-[1px] leading-[1.4] max-w-[100px]">
                  Happy Clients
                </div>
              ...
              <div className="relative flex-1 ">
                <div className="text-2xl xl:text-4xl font-extrabold text-blue-400 mb-2">
                  <CountUp start={0} end={271} duration={5} /> +
                </div>
                <div className="text-xs uppercase tracking-[1px] leading-[1.4] max-w-[100px]">
                  Finshed Projects
                </div>
            ...
            {aboutData.map((item, itemIndex) => {
              return (
                <div
                  ...
                  className={` ${
                    index === itemIndex &&
                    "text-blue-400 after:w-[100%] after:bg-blue-400 after:transition-all after:duration-300"
                  }
